...
namespace com.baidu.ai
{
   public class tokenreponse {
...

    {
        ...
        public static tokenret getAccessToken(string cid="rcCArR8S4zWdbz7fSGqocFeB",string cse="1MZAYFpx8QhdNFap8PbPM3q9WOwwIiVq")
        {
            ...
            paraList.Add(new KeyValuePair<string, string>("client_secret", cse));
