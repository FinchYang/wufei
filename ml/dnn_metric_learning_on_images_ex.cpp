...
int main(int argc, char** argv)
{
    if (argc != 3)
    {
        ...
        cout << "   ./dnn_metric_learning_on_images_ex johns steps" << endl;
        return 1;
    }
    ...
    // this to something like 10000 so training doesn't terminate too early.
                cout << "555" << endl;
    trainer.set_iterations_without_progress_threshold(atoi(argv[2]));
    ...
    std::thread data_loader9([data_loader](){ data_loader(9); });
    std::thread data_loader10([data_loader](){ data_loader(10); });

/*
    std::thread data_loader11([data_loader](){ data_loader(11); });
    std::thread data_loader12([data_loader](){ data_loader(12); });
    std::thread data_loader13([data_loader](){ data_loader(13); });
    std::thread data_loader14([data_loader](){ data_loader(14); });
    std::thread data_loader15([data_loader](){ data_loader(15); });
    std::thread data_loader16([data_loader](){ data_loader(16); });
    std::thread data_loader17([data_loader](){ data_loader(17); });
    std::thread data_loader18([data_loader](){ data_loader(18); });
    std::thread data_loader19([data_loader](){ data_loader(19); });
    std::thread data_loader20([data_loader](){ data_loader(20); });


    std::thread data_loader21([data_loader](){ data_loader(21); });
    std::thread data_loader22([data_loader](){ data_loader(22); });
    std::thread data_loader23([data_loader](){ data_loader(23); });
    std::thread data_loader24([data_loader](){ data_loader(24); });
    std::thread data_loader25([data_loader](){ data_loader(25); });
    std::thread data_loader26([data_loader](){ data_loader(26); });
    std::thread data_loader27([data_loader](){ data_loader(27); });
    std::thread data_loader28([data_loader](){ data_loader(28); });
    std::thread data_loader29([data_loader](){ data_loader(29); });
    std::thread data_loader30([data_loader](){ data_loader(30); });
*/
    ...
    //serialize(strcat("metric_network_renset.dat",argv[2])) << net;
    serialize("metric_network_renset.dat") << net;

    cout << "done serialize" << endl;
